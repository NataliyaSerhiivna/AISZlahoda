...
public class StoreProduct {
    ...
    public StoreProduct(String UPC, String promotionalUPC, Product product, BigDecimal price, int amount, boolean promotional) {
        this.UPC = UPC;
    ...
    public String toString() {
        ...
        builder.append("StoreProduct [UPC=").append(UPC)
                .append(", promotionalUPC=").append(promotionalUPC)
                .append(", product=").append(product)
                .append(", price=").append(price)
                .append(", amount=").append(amount)
                .append(", promotional=").append(promotional)
                .append("]");
